    ...
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <div class="container">
          ...
          <a href="#" class="d-lg-none d-md-inline-block"><img src="../assets/images/1701714126067.png" class="img-fluid" width="155px"></a>
        </div>
      </nav>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control" placeholder="Masukan alamat email" required="">
                  </div>
                  <div class="form-group">
